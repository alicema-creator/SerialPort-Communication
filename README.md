...
Qt+C++实现的串口通信工具带实时曲线图SerialPort-Communication
...
## 前言
这篇源码针对<<Qt+C++实现的串口通信工具带实时曲线图SerialPort-Communication>>编写代码，代码整洁，规则，易读。 学习与应用推荐首选。
...
## 运行效果
<img src="https://github.com/alicema-creator/SerialPort-Communication/blob/main/screenshot/1.png" width="500"></a>
